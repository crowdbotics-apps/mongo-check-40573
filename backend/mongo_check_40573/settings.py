"""
Django settings for mongo_check_40573 project.
...
ROOT_URLCONF = 'mongo_check_40573.urls'
...
WSGI_APPLICATION = 'mongo_check_40573.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mongo_check_40573 API",
    "DESCRIPTION": "API documentation for mongo_check_40573 App",
    "VERSION": "v1",
}
